...
const BackgroundColorPicker: React.FC<BackgroundColorPickerProps> = ({ onColorSelect, disabled = false }) => {
  ...
  return (
    <div className="relative">
      ...
      >
        {/* Background color icon: letter A with background box */}
        <div className="w-full h-full flex items-center justify-center relative">
          ...
          <div
            ...
            style={{
              backgroundColor: selectedColor === 'transparent' ? 'white' : selectedColor,
              border: selectedColor === 'transparent' ? '1px dashed #9CA3AF' : '1px solid rgba(0,0,0,0.1)'
            }}
          />
        </div>
      </ToolbarButton>
